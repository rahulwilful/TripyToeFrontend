          ...
          <div class="">
            <div class="container container-sm container-md container-lg container-xl container-xxl d-flex justify-content-center align-items-center pb-5">
              <div v-auto-animate class="">
                ...
                <!--  -->
                <div v-auto-animate v-for="item in itinerarys" :key="item">
                  <div v-auto-animate class="card card-hover shadow-lg mt-2 pe-auto" style="cursor: pointer">
                    <div v-auto-animate class="card-body d-flex justify-content-around w-100">
                      <div @click="getItinerary(item._id)" class="w-25 d-flex justify-content-center">
                      ...
                      <div class="w-25 d-flex justify-content-center">
                        <p class="mb-1 text-dark d-flex bg-transparent">
                          <span @click="deleteItinerary(item._id)" class="pe-auto delete-button"> <i class="bi bi-trash3"></i> </span>
                        </p>
                      </div>
                    </div>
                  </div>
    ...
    async deleteItinerary(id) {
      ...
      try {
        ...
        if (response) {
          ...
          this.itinerarys = this.itinerarys.filter((itinerary) => itinerary._id != id);
        }
      } catch (err) {
