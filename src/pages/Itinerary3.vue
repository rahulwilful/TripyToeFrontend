                ...
                <div v-auto-animate class="carousel-inner" style="height: 100%; position: relative">
                  ...
                  <div class="h-100 w-100 py-3" style="position: absolute">
                    <div class="w-100 h-50 d-flex justify-content-center align-items-center">
                      <span v-if="no_of_days == 1">
                        <h2 class="text-light fw-semibold" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5); text-transform: capitalize">{{ no_of_days }} Day Trip To {{ destination }}</h2>
                      </span>
                      <span v-else>
                        <h2 class="text-light fw-semibold" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5); text-transform: capitalize">{{ no_of_days }} Days Trip To {{ destination }}</h2>
                      </span>
                    </div>
                    <div class="h-50">
